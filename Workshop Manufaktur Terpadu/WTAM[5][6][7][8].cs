...
namespace Simple_Serial_Communication{
    public partial class WTAM : Form{
        ...
        private void button1_Click(object sender, EventArgs e){
            try{
                if (connectStatus == false){
                    ...
                    serialPort1.NewLine = "\r\n";
                    WTAM.ActiveForm.Text = serialPort1.PortName + " is connected.";
                }
                else{
                    WTAM.ActiveForm.Text = "Already connected!";
                    toolStripStatusLabel1.Text = "Message";
                }
            }
        ...
        private void button2_Click(object sender, EventArgs e){
            serialPort1.Close();
            connectStatus = false;
            WTAM.ActiveForm.Text = "Serial Communication";
        ...
        private void button3_Click(object sender, EventArgs e){
            if(connectStatus == true){
                ...
                WTAM.ActiveForm.Text = "Not connected yet, please connect to the correct Port first";
            }
        }
